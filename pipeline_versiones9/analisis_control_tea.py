...
def _plot_connectome_triplet_panel(
    ...
    difference_notes = {
        "correlacion": (
            "En TEA − controles, los valores positivos indican una asociación funcional promedio "
            "mayor en TEA y los negativos, una asociación funcional promedio menor en TEA."
        ),
        "lasso": (
            "En TEA − controles, los valores positivos indican una dependencia condicional promedio "
            "mayor en TEA y los negativos, una dependencia condicional promedio menor en TEA."
        ),
        "lingam": (
            "En TEA − controles, los valores positivos indican un peso dirigido relativo promedio "
            "mayor en TEA y los negativos, un peso dirigido relativo promedio menor en TEA."
        ),
    }
    note_lines = [difference_notes.get(method, "Los valores corresponden a la diferencia TEA − controles.")]
    if method == "lingam":
